...
def final_page():
        ...
        for r, u in uv_today:
            ...
            try:
                if plan == "A":
                    ...
                    v0 = u.get("rare20") or {}
                    if v0.get("flag") and v0.get("ex_skip") is False:
    ...
    def _uv_row(label, s, live=False, color=None, plan=None):
    ...
    uv_live = ('<div class="fcard" style="border-color:#1c7a38;background:#f4fbf6">'
               ...
               + ((_uv_row("波乱BOX①：2連単BOX（1号艇以外の総合力上位3艇・6点×1,000円／波乱の目≤20%かつ展示で1号艇3位以下）",
                   ...
                   + _uv_row("波乱BOX②：3連単BOX（1号艇を含む総合力上位4艇・24点×1,000円／波乱の目≤20%かつ展示で1号艇3位以下）",
                             _rare_box_today_stats("box4"), live=True, color="#8a6d1f", plan="RB4")) if _RARE_BOX_LIVE else "")
    ...
    def card(r):
        ...
        _rbox = [(k, (_rbsrc.get(k) or {})) for k in ("box2", "box4")] if (_rbsrc and _RARE_BOX_LIVE) else []
