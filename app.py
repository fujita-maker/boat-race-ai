        ...
        if n == 0:
            ...
            h += ('<table style="margin-top:8px"><tr><th>締切</th><th>場R</th><th>1号艇モ</th>'
                  ...
                  '<th>%s</th><th>結果</th></tr>' % ('買い目（16点＋2連単BOX 6点＋3連単BOX 24点＝46,000円）'
                                                     if (_RARE_BOX_LIVE and field == "rare20") else '買い目(頭-2着4艇-3着全=16点=16,000円)'))
            for c in cands:
                rr = c["rr"]
                ...
                if _RARE_BOX_LIVE and field == "rare20":   # v126b: 波乱BOX 2種を併記
                    if not rr.get("ab"):
                        rr["ab"] = _box_ab(c["rc"])
                ...
                if c["led"]:
                    ...
                    res = "締切後"
                if _RARE_BOX_LIVE and field == "rare20" and c["done"]:   # v126b: BOXの当否
                ...
                if _RARE_BOX_LIVE and field == "rare20":   # v133: 判定(買い候補/見送り)の上に A・B の目印を大きく出す
