...
def today_page():
    ...
    def render_rows(rows):
        h = ('<table><tr><th>締切</th><th>場</th><th>R</th>'
             '<th>的中モデル(上位%d点)</th><th>高オッズEV</th></tr>' % topn)
        for r in rows:
    ...
    legend = ('<div class="small">的中モデル＝GBM上位%d点（<span class="pill pbuy" style="padding:1px 6px">買い</span>'
              '＝自信度上位20%%、それ以外は様子見）。高オッズEV＝1-4/1-5・オッズ≥20・EV≥1.2。</div>' % topn)
